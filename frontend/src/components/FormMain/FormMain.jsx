  ...
  function Dropzone() {
    ...
    const Items = files.map((file) => (
      <div className="preview-item" key={file.path}>
        ...
        <span className="preview-item__del" onClick={() => fileRemove(file)}>
    ...
    return (
      <div className="container-flex">
        ...
        <form encType="multipart/form-data" method="POST" id="form" action="http://localhost:3001/form">
        ...
        {Items.length > 0 ? (
          <div>
            <button
              className="btn-secundary btn-border-blue"
              form="form"
              type="submit"
            >
              <p>Finalizar Envio!</p>
